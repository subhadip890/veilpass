/**
 * Deploy VeilPass contract to a Midnight network.
 * Default: local devnet (undeployed). Use --network preview|preprod for public networks.
 */
import * as fs from 'node:fs';
import * as path from 'node:path';
import { resolveNetwork, getOrCreateWallet, formatWalletBackupNotice, recordDeployment, getPrivateStatePassword } from './network.js';
...
// Private state ID — must match CLI and test scripts.
...
// Supply dummy witness for Contract constructor during deployment.
...
async function main() {
  console.log('\n╔══════════════════════════════════════════════════════════════╗');
  console.log('║              VeilPass — Deploy Contract                      ║');
  console.log('╚══════════════════════════════════════════════════════════════╝\n');
