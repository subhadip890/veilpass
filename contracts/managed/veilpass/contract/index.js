...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.privateAge) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named privateAge');
    }
      ...
      checkEligibility: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('checkEligibility',
                                     ...
                                     'veilpass.compact line 42 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
  ...
  _privateAge_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.privateAge(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 65535n)) {
      __compactRuntime.typeError('privateAge',
                                 'return value',
                                 'veilpass.compact line 36 char 1',
                                 'Uint<0..65536>',
                                 result_0)
    }
  ...
  _checkEligibility_0(context, partialProofData, threshold_0) {
    __compactRuntime.assert(threshold_0
                            ...
                            'threshold cannot be below policy threshold (18)');
    const age_0 = this._privateAge_0(context, partialProofData);
    const isEligible_0 = age_0 >= threshold_0;
    __compactRuntime.assert(isEligible_0, 'age is below threshold');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
...
const _dummyContract = new Contract({ privateAge: (...args) => undefined });
